...
$(document).ready(function(){
    ...
    function init_template(){
        ...
        $('.democ-1').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-1');
			localStorage.setItem("fondo",'gradient-body-1')
		});
        $('.democ-2').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-2');
			localStorage.setItem("fondo",'gradient-body-2')
		});      
        $('.democ-3').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-3');
			localStorage.setItem("fondo",'gradient-body-3')
		});      
        $('.democ-4').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-4');
			localStorage.setItem("fondo",'gradient-body-4')
		});      
        $('.democ-5').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-5');
			localStorage.setItem("fondo",'gradient-body-5')
		});      
        $('.democ-6').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-6');
			localStorage.setItem("fondo",'gradient-body-6')
		});
        $('.democ-7').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-7');
			localStorage.setItem("fondo",'gradient-body-7')
		});
        $('.democ-8').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-8');
			localStorage.setItem("fondo",'gradient-body-8')
		});
        $('.democ-9').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-9');
			localStorage.setItem("fondo",'gradient-body-9')
		});
		$('.democ-10').on('click', function(){
			$('.page-bg, .menu-bg').removeClass(democs).addClass('gradient-body-10');
			localStorage.setItem("fondo",'gradient-body-10')
		});
		...
		if($('.chart').length > 0){
			...
			var call_charts_to_page = function(){
				new Chart(document.getElementById("pie-chart"), {
					type: 'pie',
					data: {
					  labels: ["Individuales", "Grupales", "Cruzados", "Educativos"],
					  datasets: [{
						backgroundColor: ["#4A89DC", "#4FC1E9", "#FC6E51", "#ED5565"],
						borderColor:"rgba(255,255,255,1)",
						data: [7000,3000,1000,2000]
					  }]
					},
					options: {
				...
				new Chart(document.getElementById("doughnut-chart"), {
					type: 'doughnut',
					data: {
					  labels: ["Pre-venta", "Venta", "Post-Venta", "otros"],
					  datasets: [{
						backgroundColor: ["#CCD1D9", "#5D9CEC","#FC6E51", "#4FC1E9"],
						borderColor:"rgba(255,255,255,1)",
						data: [5500,4000,2000,3000]
					  }]
					},
					options: {
						legend: {display: true, position:'bottom', labels:{fontSize:13, padding:15,boxWidth:12},},
				...
				new Chart(document.getElementById("polar-chart"), {
					type: 'polarArea',
					data: {
					  labels: ["MapasGeo", "PerfilCliente", "Recolección de info","Gestiones"],
					  datasets: [{
						backgroundColor: ["#CCD1D9", "#5D9CEC","#FC6E51","#FC7E14"],
						borderColor:"rgba(255,255,255,1)",
						data: [7000,10000,5000,3000]
					  }]
					},
					options: {
						legend: {display: true, position:'bottom', labels:{fontSize:13, padding:15,boxWidth:12},},
